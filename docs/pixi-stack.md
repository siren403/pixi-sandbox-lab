...
- loading overlay는 progress bar를 포함하고, 연출 확인을 위해 최소 500ms 유지한다.
- `window.__pixiRuntimeState`는 E2E용으로 loading 상태, scene switch 수, loading overlay 표시 수, 마지막 loading duration, progress를 노출한다.
