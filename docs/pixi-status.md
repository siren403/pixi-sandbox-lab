...
- The vertical slice scene contains a larger explorable world with many demo objects; drag pans the camera and wheel/pinch zoom adjusts the view while taps still move the player.
