...
- `.codex/agents/context-engineer.toml` defines the project-local Codex custom agent for context architecture, source-of-truth boundaries, prompt/doc refactors, and context-loading strategy.
